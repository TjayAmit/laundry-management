        ...
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-gradient-to-br from-[#0a0a0a] via-[#1a1410] to-[#0a0a0a] p-6 text-white lg:justify-center lg:p-8">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-7xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href={dashboard()}
                                className="inline-block rounded-lg border border-[#ff6b35]/30 bg-[#ff6b35]/10 px-5 py-2 text-sm font-medium leading-normal text-[#ff6b35] transition-all hover:border-[#ff6b35] hover:bg-[#ff6b35]/20"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href={login()}
                                    className="inline-block rounded-lg border border-transparent px-5 py-2 text-sm font-medium leading-normal text-gray-300 transition-all hover:text-[#ff6b35]"
                                >
                                    Log in
                                </Link>
                                {canRegister && (
                                    <Link
                                        href={register()}
                                        className="inline-block rounded-lg border border-[#ff6b35] bg-[#ff6b35] px-5 py-2 text-sm font-medium leading-normal text-white transition-all hover:bg-[#ff5722] hover:border-[#ff5722]"
                                    >
                                        Get Started
                                    </Link>
                                )}
                    ...
                    <main className="flex w-full max-w-[335px] flex-col lg:max-w-7xl">
                        ...
                        <div className="mb-12 text-center lg:mb-16">
                            ...
                            <p className="mx-auto mb-8 max-w-2xl text-lg text-gray-400 lg:text-xl">
                                Complete management solution for laundry services with real-time tracking,
                                customer notifications, and QR-based transactions. Scale your business effortlessly.
                            </p>
                        ...
                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="group rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-[#ff6b35]/50 hover:shadow-lg hover:shadow-[#ff6b35]/10">
                                ...
                                <h3 className="mb-2 text-lg font-semibold text-white">Smart Notifications</h3>
                                <p className="text-sm leading-relaxed text-gray-400">
                                    Automated SMS and email alerts keep customers informed about order status,
                                    ready for pickup notifications, and promotional offers.
                                </p>
                            </div>
                            ...
                            <div className="group rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-[#ff6b35]/50 hover:shadow-lg hover:shadow-[#ff6b35]/10">
                                ...
                                <h3 className="mb-2 text-lg font-semibold text-white">Multi-Branch Control</h3>
                                <p className="text-sm leading-relaxed text-gray-400">
                                    Centralized dashboard to manage multiple locations, staff assignments,
                                    inventory levels, and performance metrics across all branches.
                                </p>
                            </div>
                            ...
                            <div className="group rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-[#ff6b35]/50 hover:shadow-lg hover:shadow-[#ff6b35]/10">
                                ...
                                <p className="text-sm leading-relaxed text-gray-400">
                                    Real-time order processing from intake to delivery with status updates,
                                    service tracking, and detailed customer order history.
                                </p>
                            </div>
                            ...
                            <div className="group rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-[#ff6b35]/50 hover:shadow-lg hover:shadow-[#ff6b35]/10">
                                ...
                                <h3 className="mb-2 text-lg font-semibold text-white">QR-Based System</h3>
                                <p className="text-sm leading-relaxed text-gray-400">
                                    Contactless check-in and payment processing with QR codes for faster service,
                        ...
                        <div className="mt-16 grid gap-8 rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-8 backdrop-blur-sm sm:grid-cols-3 lg:mt-20">
                            <div className="text-center">
                                <div className="mb-2 text-4xl font-bold text-[#ff6b35]">99.9%</div>
                                <div className="text-sm font-medium text-gray-400">Uptime Guarantee</div>
                            </div>
                            <div className="text-center">
                                <div className="mb-2 text-4xl font-bold text-[#ff6b35]">24/7</div>
                                <div className="text-sm font-medium text-gray-400">Customer Support</div>
                            </div>
                            <div className="text-center">
                                <div className="mb-2 text-4xl font-bold text-[#ff6b35]">500+</div>
                                <div className="text-sm font-medium text-gray-400">Active Businesses</div>
                            </div>
                        </div>
                    </main>
                </div>
                ...
                <footer className="mt-16 w-full text-center text-sm text-gray-500 lg:mt-20">
                    <p>&copy; {new Date().getFullYear()} Laundry Management System. All rights reserved.</p>
                </footer>
